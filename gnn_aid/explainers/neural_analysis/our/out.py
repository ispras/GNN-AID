...
from gnn_aid.explainers.neural_analysis.orig.graph_utils import edge_index_to_tuples, add_edge
...
class NeuralAnalysisExplainer(Explainer):
    ...
    def expl_gp_neurons(self, graph, y, level, concepts=None, gamma=0.5, rank=1, debug=False,
        ...
        from gnn_aid.explainers.neural_analysis.our import concept_ranker
