...
from gnn_aid.aux.data_info import UserCodeInfo
from gnn_aid.aux.declaration import Declare
from gnn_aid.aux.utils import (
    POISON_ATTACK_PARAMETERS_PATH, EVASION_ATTACK_PARAMETERS_PATH, MI_ATTACK_PARAMETERS_PATH,
    POISON_DEFENSE_PARAMETERS_PATH, EVASION_DEFENSE_PARAMETERS_PATH, MI_DEFENSE_PARAMETERS_PATH,
    import_by_name, all_subclasses, FRAMEWORK_PARAMETERS_PATH, model_managers_info_by_names_list,
    hash_data_sha256, TECHNICAL_PARAMETER_KEY, IMPORT_INFO_KEY, OPTIMIZERS_PARAMETERS_PATH,
    FUNCTIONS_PARAMETERS_PATH, move_to_same_device)
from gnn_aid.data_structures.configs import (
    ConfigPattern, PoisonAttackConfig, CONFIG_OBJ, EvasionAttackConfig, MIAttackConfig,
    PoisonDefenseConfig, EvasionDefenseConfig, MIDefenseConfig, ModelManagerConfig,
    ModelModificationConfig, ModelConfig, CONFIG_CLASS_NAME, Task)
...
from .gnn_constructor import FrameworkGNNConstructor
...
class GNNModelManager:
    ...
    def from_model_path(
        ...
        if class_name in framework_model_managers_info.keys():
            klass = import_by_name(class_name, ["gnn_aid.models_builder.gnn_models"])
