...
from gnn_aid.attacks.qattack.utils import get_adj_list, from_adj_list, adj_list_oriented_to_non_oriented
...
class QAttacker(EvasionAttacker):
    ...
    def init(self, gen_dataset):
        ...
        """
        assert self.individual_size * 2 < gen_dataset.data.edge_index.shape[1], "Too big individual_size for this dataset"
    ...
    def attack(self, model_manager, gen_dataset, mask_tensor, **kwargs):
        ...
        gen_dataset.data.edge_index = from_adj_list(adj_list)
        return gen_dataset
